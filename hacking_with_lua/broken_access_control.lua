...
io.write("Enter your target URL: ")
local target_url = io.read()
...
-- Perform tests
print("Performing broken access control test...")
for _, command in ipairs(test_commands) do
    print("Command: " .. command)
    print(execute_command(command))
    print()
end

print("Broken access control test completed.")
